...
Use this skill only inside the `codex-jr:codex-rescue` subagent.
...
- Do not call `setup`, `review`, `adversarial-review`, `status`, `result`, or `cancel` from `codex-jr:codex-rescue`.
